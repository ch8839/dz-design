...
function generateToken(fileType) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const baseResult = generateTypeToken(
      token_json_1.default.base || [],
      fileType,
      "base"
    );
    const commonResult = generateTypeToken(
      token_json_1.default.common || [],
      fileType,
      "common"
    );
    ...
    fs_extra_1.default.writeFile(
      path_1.default.join(outputPath, `output.${fileType}`),
      result
    );
  });
}
